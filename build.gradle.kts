...
plugins {
  ...
  id("org.sonatype.gradle.plugins.scan") version "4.1.0-02"
...
val dependencyVersions = listOf(
  ...
  "net.bytebuddy:byte-buddy:1.18.13",
  "net.bytebuddy:byte-buddy-agent:1.18.13",
...
//      }
      dependencySubstitution {
        substitute(module("de.gesellix:docker-remote-api-model-1-41"))
          .using(module("de.gesellix:docker-remote-api-model-1-44:2.0.202607262220"))
      }
    }
  }
}
