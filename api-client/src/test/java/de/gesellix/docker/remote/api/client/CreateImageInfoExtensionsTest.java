...
class CreateImageInfoExtensionsTest {
  ...
  public void getImageIdFromStatus() {
    ...
    infos.add(new CreateImageInfo("example", null, "Pulling from gesellix/echo-server", null, null));
    ...
    infos.add(new CreateImageInfo(null, null, "Status: Image is up to date for gesellix/echo-server:example", null, null));
